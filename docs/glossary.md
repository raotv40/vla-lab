...
| **End-Effector** | The endpoint of a robot arm (for example, a fingertip or gripper) that interacts directly with the environment. | Day 1 | Day 7 | ⭐⭐⭐⭐⭐ |
...
| **Forward Kinematics** | Calculating the Cartesian position $(x, y)$ of the end-effector (fingertip) given the joint angles $(\theta_1, \theta_2)$. | Day 2 | Day 7 | ⭐⭐⭐⭐⭐ |
...
| **Kinematic Chain** | A series of rigid link links connected sequentially by movable joints. | Day 7 | Day 7 | ⭐⭐⭐⭐⭐ |
