...
- **Output**:
  ...
  ```
- **Plot**:
  ![P Controller Step Response](../../assets/day10/p_controller.png)
...
- **Output**:
  ...
  ```
- **Plot**:
  ![PI Controller Step Response](../../assets/day10/pi_controller.png)
...
- **Output**:
  ...
  ```
- **Plot**:
  ![PID Controller Step Response](../../assets/day10/pid_controller.png)
...
| **Complexity** | Extremely low (few arithmetic operations) | High (requires deep neural network forward passes) |
